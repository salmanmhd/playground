    ...
    setTimeout(() => {
      try {
        ...
        let x = 10,
          y = 10;
        const boxWidth = 90;
        const boxHeight = 60; // Reduced height to fit 12 boxes per page
        const marginLeft = 5;
        const lineHeight = 5; // Slightly reduced line height

        // Add title to the PDF
        doc.setFontSize(14);
        doc.text('Address Labels', 105, 10, { align: 'center' });
        doc.setFontSize(10);
        ...
        addresses.forEach((addr, i) => {
          if (i % 3 === 0 && i !== 0) {
            x = 10;
            y += boxHeight + 5; // Reduced spacing between rows
          }
          ...
          // Limit to max 4 lines for address to avoid overflow
          const limitedAddressLines = addressLines.slice(0, 4);
